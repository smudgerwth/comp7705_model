...
Updated with LightGBM (Regression only) on 2024-05-10
"""
import pandas as pd
import numpy as np
...
def predict_insurance(health_data):
    ...
    return {
        'base_premium': round(float(base_premium[0]), 2),
        'adjusted_premium': round(float(base_premium[0]) * health_adj, 2),
...
# (base) karl@JCV9Q9QRK2 COMP7705 % python CASDataScript/LightBGM_V1.py 
# [LightGBM] [Warning] No further splits with positive gain, best gain: -inf
# Training until validation scores don't improve for 10 rounds
# [LightGBM] [Warning] No further splits with positive gain, best gain: -inf
# [LightGBM] [Warning] No further splits with positive gain, best gain: -inf
# Early stopping, best iteration is:
# [70]	valid_0's rmse: 15437.3

# 回归模型评估:
# PremTotal预测RMSE: 15437.321494330576
# PremTotal预测R²: 0.0019118990372212208

# 预测结果示例:
# {'base_premium': 1891.01, 'adjusted_premium': 1880.39, 'health_score': 0.472}